...
2.**Data Refinement**: Transforming Raw Information into Business Wisdom.Embarked on an exploration through the intricacies of data, leveraging Power Query's magic to purify and mold raw data, shaping detailed columns that ignite strategic insights.After the data cleaning step the data was added to the power pivot.The following points were checked during this step:
